...
namespace DataBIDV.Extensions
{
    ...
    public static class JWE
    {
                ...
                case SerializationMode.Compact:
                    {
                        ...
                        return new DataBIDV.Extensions.JweToken(
                                        header,
                                        null,
                                        recipientsOut,
                                        null,
        ...
        public static JweToken Headers(string jwe, JwtSettings settings = null)
        {
            ...
            var token = DataBIDV.Extensions.JweToken.FromString(jwe, settings.JsonMapper);
        ...
        {
            return settings ?? DataBIDV.Extensions.JWT.DefaultSettings;
        }
